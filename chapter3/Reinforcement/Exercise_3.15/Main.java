...
/**
 *
 *  Data Structures and Algorithm with Java - Chapter 3.15 Exercise
 *
 *  --------------------------------------------------------------------------------
...
public class Main {
    public static void main(String[] args) {
        CircularlyLinkedList c1 = new CircularlyLinkedList();
        c1.addLast(1);
        c1.addLast(2);
        c1.addLast(3);
        ...
        CircularlyLinkedList c2 = new CircularlyLinkedList();
        c2.addLast(1);
        c2.addLast(2);
        c2.addLast(4);
        System.out.println("c2 " + c2.toString());

        CircularlyLinkedList c3 = new CircularlyLinkedList();
        c3.addLast(1);
        c3.addLast(2);
        c3.addLast(3);
        System.out.println("c3: " + c3.toString());

        // calling implementing equals method
